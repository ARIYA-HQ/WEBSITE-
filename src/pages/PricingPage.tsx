        ...
        <div className="min-h-screen bg-beige-100 dark:bg-gray-950 pt-32 pb-24 overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto px-8">
                ...
                <div className="text-center mb-24 max-w-4xl mx-auto">
                    <motion.div {...fadeIn}>
                        <span className="section-label mb-4 block text-[10px] font-black uppercase tracking-widest text-primary-600">Pricing & Implementation</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-32">
                    {PRICING_CONFIG.plans.map((plan, idx) => (
                        ...
                        >
                            ...
                            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-6 transition-colors ${plan.featured
                                    ? 'bg-primary-600 text-white'
                                    : `bg-${plan.color}-50 dark:bg-${plan.color}-900/20 text-${plan.color}-600 dark:text-${plan.color}-400 group-hover:bg-${plan.color}-600 group-hover:text-white`
                                }`}>
                            ...
                            <p className={`text-sm mb-8 leading-relaxed ${plan.featured ? 'text-gray-400' : 'text-gray-500 dark:text-gray-400'}`}>
                                {plan.description}
                            </p>
                ...
                <div className="mb-32">
                    <div className="text-center mb-16">
                        <span className="section-label text-[10px] font-black uppercase tracking-widest text-[#D0771E]">Restricted Unlocks</span>
                ...
                {/* Digital Products & Cards (Static UI with standardized components) */}
