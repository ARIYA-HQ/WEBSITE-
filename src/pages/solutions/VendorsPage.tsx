...
export default function VendorsPage() {
    return (
        <main className="pt-24 min-h-screen bg-white">
            {/* Hero */}
            <section className="bg-primary-50 py-24 px-8 rounded-b-[3rem]">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div className="flex-1">
                        <div className="grid grid-cols-2 gap-6">
                            ...
                            <div className="bg-white p-8 rounded-[2rem] shadow-lg translate-y-8">
            ...
            <section className="py-24 px-8 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-black tracking-tight">Grow Your Business on Autopilot</h2>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {[
                        ...
                        <div key={i} className="text-center px-4">
                            <div className="w-16 h-16 bg-gray-50 rounded-full flex items-center justify-center mx-auto mb-6 text-primary-600">
