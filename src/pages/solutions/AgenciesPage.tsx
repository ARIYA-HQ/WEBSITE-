            ...
            <section className="relative py-32 px-8 overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <h1 className="text-5xl md:text-7xl font-black tracking-tighter mb-8 text-gray-900 leading-none">
                        ...
                        <button className="bg-black text-white font-black uppercase tracking-widest px-10 py-5 rounded-full text-sm hover:translate-x-2 transition-transform">
                            Book a Demo
                        </button>
                    </div>
                    <div className="relative">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="space-y-4 mt-12">
                                <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 animate-in slide-in-from-bottom-5 duration-1000">
                                    <BarChart3 className="w-8 h-8 text-primary-600 mb-4" />
                                    <div className="font-bold text-lg">Global Analytics</div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-100 animate-in slide-in-from-bottom-5 duration-1000 delay-300">
