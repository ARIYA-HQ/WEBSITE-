                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 mt-8 md:mt-0">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-4 w-full md:w-auto">
                        <button
                            ...
                            className="bg-white dark:bg-gray-800 text-gray-900 dark:text-white px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-gray-50 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700 transition-colors flex items-center justify-center gap-2 w-full sm:w-auto"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="bg-primary-600 text-white px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-primary-700 transition-colors flex items-center justify-center gap-2 w-full sm:w-auto whitespace-nowrap"
                        >
