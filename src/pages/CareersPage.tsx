    ...
    return (
        <main className="pt-24 bg-beige-50 min-h-screen">
            <section className="relative py-32 text-center px-4">
                ...
                <button className="bg-black text-white font-black uppercase tracking-widest px-10 py-5 rounded-full text-sm hover:scale-105 transition-transform">
                    View Open Roles
                </button>
            </section>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-8">
                    ...
                    <h2 className="text-4xl font-black tracking-tight mb-16 text-center">Perks & Benefits</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={i} className="p-8 border border-gray-100 rounded-[2rem] hover:border-primary-200 hover:bg-primary-50/30 transition-all">
            ...
            <section className="py-24 px-8 max-w-5xl mx-auto">
                <h2 className="text-4xl font-black tracking-tight mb-12">Open Positions</h2>
                <div className="space-y-4">
                    {[
                        ...
                        <div key={i} className="bg-white p-8 rounded-[1.5rem] flex flex-col md:flex-row items-center justify-between shadow-sm hover:shadow-lg transition-all border border-transparent hover:border-primary-100 cursor-pointer group">
                            <div>
                                <h3 className="text-xl font-bold text-gray-900 mb-2 group-hover:text-primary-600 transition-colors">{job.role}</h3>
